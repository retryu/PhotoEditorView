...
import com.tencent.zebra.effect.utils.RotateView;
...
//        path ="/storage/emulated/0/image/aadajiang.jpg";
        ...
        Bitmap original = Util.getOrResizeBitmap(path, true, result);
        orignRatio = ((float)original.getHeight())/((float)original.getWidth());
        Log.d("debug","[CropActivity]  width:"+original.getWidth()+"  height:"+original.getHeight());
